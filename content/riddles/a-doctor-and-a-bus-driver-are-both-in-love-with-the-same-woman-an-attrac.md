---
title: >-
  A doctor and a bus driver are both in love with the same woman, an attractive
  girl named Sarah?
slug: a-doctor-and-a-bus-driver-are-both-in-love-with-the-same-woman-an-attrac
description: >-
  A doctor and a bus driver are both in love with the same woman, an attractive
  girl named Sarah The answer is an apple a day keeps the doctor away!.
